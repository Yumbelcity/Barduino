...
import Pedido from '../../components/Restaurant/Pedido'
...
export default class Pedidos extends Component {
  constructor() {
    ...
    this.refPedidos = firebase.database().ref().child('pedido').orderByChild('_idUsuario').equalTo(firebase.auth().currentUser.uid)
  }
